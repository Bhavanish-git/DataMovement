...
public class OrigTable {
	...
	private String 
			...
			BRANCH= null,
			CFE_ID= null,
			COA_DSA_MG_EMP_ID= null,
			CROSS_SELL_PRODUCT= null,
			CUST_ID= null,
			EMPLOYEE_GRADE_PER= null,
			MANUFACTURER= null,
			OSB_BATCH_ID= null,
			PRODUCT= null,
			PSA_FLAG= null,
			...
			RULE_NO= null,
			SCHEME= null,
			SCHEME_INCENTIVE= null,
			SCHEME_TYPE= null,
			SCHEME_TYPE_ADD= null,
			SFE_ID= null,
			SFE_PSA_INCENTIVE= null,
			STATUS= null,
			TL_ID= null,
			ZONE= null;

	private Integer TOTAL_CE_VOLUME=0 ,TOTAL_FILE_PROCESSED=0,AMOUNT_FINANCED=0,AVG_TEAM_PRODUCTIVITY=0,BROKER_AMT=0,BUSINESS_IRR=0,
	...
	private double SC_INCENTIVE = 0.0d ,TL_SC_INCENTIVE = 0.0d;        
